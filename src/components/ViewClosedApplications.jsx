      ...
      <Table className={classes.table} aria-label="simple table">
        ...
        <TableBody>
            <TableRow>
              ...
              <TableCell align="center"><Link to={`/closeddetailedview/${row._id}`} style={{ textDecoration: 'none'}}><Button variant="contained" color="primary" style={{marginTop:"10px",marginLeft:10,width: "370px",
            ...
            height: "40px",color: '#FFFFFF',fontSize:'19px'}}><b>Reopen This Application</b></Button></TableCell>
            </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
